...
- (void)pinched:(UIPinchGestureRecognizer *)pinchGR {
    if (pinchGR.state == UIGestureRecognizerStateBegan)
        [self pinchBegan];
    else if (pinchGR.state == UIGestureRecognizerStateEnded || pinchGR.state == UIGestureRecognizerStateFailed)
        [self pinchEnded];
...
- (void)panned:(UIPanGestureRecognizer *)panGR {
    if (panGR.state == UIGestureRecognizerStateBegan)
        [self panBegan];
    else if (panGR.state == UIGestureRecognizerStateEnded || panGR.state == UIGestureRecognizerStateFailed)
        [self panEnded];
